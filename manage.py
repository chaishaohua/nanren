...
@cache.cached(60*10,key_prefix="filelist_filter_cache")
...
def detail(info_hash):
    ...
    filelist=Search_Filelist.query.filter_by(info_hash=info_hash).first()
    return render_template('detail.html',form=form,tags=tags,hash=hash,keywords=keywords,actors=actors,dayhot=dayhot,weekhot=weekhot,newest=newest,filelist=filelist,sitename=sitename)
